		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, {
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Flex, {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CardImage, { src: `/react-payments/chip.svg` }), props.cardBrand && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CardImage, { src: `/react-payments/${props.cardBrand.toLowerCase()}.svg` })]
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Flex, {
					gap: 10,
					children: props.cardNumberSegments.map((segments, index) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CardText, { children: index < 2 ? segments : segments.replaceAll(/./g, "•") }, index))
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(CardText, { children: [
					props.expiryMonth,
...
`;
//#endregion
//#region src/components/Common/ValidationInput.tsx
...
`;
var ValidationInput = (0, import_react.forwardRef)(function ValidationInput({ validations, onChange, onBlur, ...props }, ref) {
	const [inputError, setInputError] = (0, import_react.useState)(null);
	const handleOnChange = (event) => {
		const failedValidation = validations.find((validation) => event.target.value.length && validation.type === "validateOnChange" && !validation.validator(event.target.value));
		if (failedValidation) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Flex, {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Input, {
			...
			onBlur: handleOnBlur
		}), props.isShowError && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(InputErrorMessage, { children: inputError?.message })]
	});
});
//#endregion
...
var CARD_BRAND_CONFIGS = {
	...
	MasterCard: { segmentLengths: [
		4,
		4,
		4,
		4
	] },
	Diners: { segmentLengths: [
		4,
		6,
		4
	] },
...
function validateMonth(input) {
	return Array.from({ length: 12 }).map((_, index) => String(index + 1).padStart(2, "0")).includes(input);
}
function validateYear(input) {
	return Array.from({ length: 100 }).map((_, index) => String(index).padStart(2, "0")).includes(input);
}
function isCardFormComplete(formState, brand) {
	const segmentLengths = brand ? CARD_BRAND_CONFIGS[brand].segmentLengths : DEFAULT_SEGMENT_LENGTHS;
	return !!(formState.cardCompany && segmentLengths.every((len, i) => formState.cardNumberSegments[i]?.length === len) && formState.expiryMonth.length === 2 && formState.expiryYear.length === 2 && formState.cvc.length === 3 && formState.cardPassword.length === 2);
}
//#endregion
//#region src/utils/validationRules.ts
var numericOnlyValidations = [{
	type: "validateOnChange",
	validator: validateNumberString,
	message: "숫자만 입력 가능합니다."
}];
var cardPasswordValidations = [
	{
		type: "validateOnChange",
		validator: validateNumberString,
		message: "숫자만 입력 가능합니다."
...
function numberSegmentValidations(maxLength) {
	return [
		{
			type: "validateOnChange",
			validator: validateNumberString,
		...
		{
			type: "validateOnChange",
			validator: (input) => validateStringMaxLength(input, maxLength),
			message: `${maxLength}자리까지만 입력 가능합니다.`
		},
		{
			type: "validateOnBlur",
			validator: (input) => validateStringLength(input, maxLength),
...
var cvcValidations = [
	...
	{
		type: "validateOnChange",
		validator: (input) => validateStringMaxLength(input, 3),
		message: "3자리까지 입력 가능합니다."
	},
	{
		type: "validateOnBlur",
		validator: (input) => validateStringLength(input, 3),
		message: "3자리를 입력해주세요."
	}
];
function expiryDateValidations(date) {
	return [
		{
			type: "validateOnChange",
			validator: validateNumberString,
		...
		},
		{
			...
			message: date === "month" ? "유효한 월을 입력해주세요. (01 ~ 12)" : "유효한 연도을 입력해주세요."
		}
	];
}
//#endregion
...
//#endregion
//#region src/components/CardExpiryDateInput.tsx
...
//#endregion
//#region src/components/CardCompany.tsx
var Wrapper$1 = styled.div`
  position: relative;
  width: 100%;
`;
var Selected = styled.div`
  display: flex;
  justify-content: space-between;
  align-items: center;
  padding: 8px 6px;
  font-size: 14px;
  color: ${({ $isOpen, $hasValue }) => $isOpen || $hasValue ? "var(--color-black)" : "var(--color-border)"};
  border: 1px solid
...
var Chevron = styled.span`
  ...
  transform: ${({ $isOpen }) => $isOpen ? "translateY(25%) rotate(-135deg)" : "translateY(-25%) rotate(45deg)"};
...
function CardCompany(props) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Wrapper$1, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Selected, {
		$hasValue: !!props.value,
		$isOpen: isOpen,
		onClick: () => setIsOpen((prev) => !prev),
		children: [props.value || "카드사를 선택해주세요", /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Chevron, { $isOpen: isOpen })]
	}), isOpen && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(OptionList, { children: CARD_COMPANIES.map((company) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Option, {
		onClick: () => handleSelect(company),
		children: company
	}, company)) })] });
}
//#endregion
//#region src/components/CardPasswordInput.tsx
function CardPasswordInput(props) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Flex, {
		direction: "column",
		gap: 10,
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Label, { children: "비밀번호 앞 2자리" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ValidationInput, {
			value: props.value,
...
function CardForm(props) {
	...
	const cvcRef = (0, import_react.useRef)(null);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("form", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Flex, {
		direction: "column",
		gap: 16,
		children: [
			isCvcComplete && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				ref: passwordRef,
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Flex, {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Flex, {
						direction: "column",
						gap: 5,
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Title, { children: "비밀번호를 입력해 주세요" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Description, { children: "앞의 2자리를 입력해주세요" })]
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CardPasswordInput, {
			...
			isExpiryComplete && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				ref: cvcRef,
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Flex, {
					direction: "column",
					gap: 10,
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Flex, {
						direction: "column",
						gap: 5,
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Title, { children: "CVC 번호를 입력해 주세요" })
			...
			isCardCompanySelected && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				ref: expiryRef,
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Flex, {
					direction: "column",
					gap: 10,
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Flex, {
						direction: "column",
						gap: 5,
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Title, { children: "카드 유효기간을 입력해 주세요" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Description, { children: "월/년도(MMYY)를 순서대로 입력해 주세요." })]
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CardExpiryDateInput, {
						value: {
			...
			isCardNumberComplete && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				ref: cardCompanyRef,
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Flex, {
					direction: "column",
					gap: 10,
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Flex, {
							direction: "column",
							gap: 5,
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Title, { children: "카드사를 선택해주세요" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Description, { children: "현재 국내 카드사만 가능합니다." })]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CardCompany, {
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: { height: "16px" } })
					]
				})
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Flex, {
...
function splitIntoSegments(fullNumber, lengths) {
	const segments = [];
	let pos = 0;
...
function useCardNumberSegments() {
	...
	const handleChange = (newSegments) => {
		...
		if (!alreadySplit || newBrand !== currentBrand) {
			setSegments(splitIntoSegments(fullNumber, newBrand ? CARD_BRAND_CONFIGS[newBrand].segmentLengths : DEFAULT_SEGMENT_LENGTHS));
			return;
		}
...
//#endregion
//#region src/hooks/useCardForm.ts
function useCardForm() {
	const { segments, brand, handleChange: handleCardNumberChange } = useCardNumberSegments();
...
//#endregion
//#region src/components/SubmitButton.tsx
...
//#endregion
//#region src/components/SubmitSuccess.tsx
var CheckImage = styled.img`
  width: 76;
  height: 76;
  top: 188px;
  left: 150px;
...
function App() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Routes, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Route, {
		path: "/react-payments",
		element: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(View, { children: [
		...
		element: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SubmitSuccess, {
